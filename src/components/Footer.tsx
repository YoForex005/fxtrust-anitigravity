            ...
            <div className="container">
                ...
                <div className={styles.bottomBar}>
                    ...
                    <div className={styles.disclaimer}>
                        ...
                        <p>
                            FXTrusts is a technology provider and does not provide financial services or advice. We do not hold client funds. All trading services are provided by our regulated partners.
                            <br /><br />
                            <strong>Middle East Office:</strong> B2007-127, 33rd floor, Latifa Tower, Trade Center first, Seikh Zayad Road, Dubai-UAE
                            <br />
                            <strong>Contact:</strong> <a href="mailto:support@fxtrust.com" style={{ color: '#3B82F6' }}>support@fxtrust.com</a>
                        </p>
                    </div>
