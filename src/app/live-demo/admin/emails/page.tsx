...
export default function EmailsPage() {
    ...
    const [activeItem, setActiveItem] = useState('All E-mails');
    ...
    const emails = [
        ...
        { subject: 'Monthly account statement', from: '---', to: '---', regarding: 'Sampat Kuntal222', priority: 'High', status: 'Draft', modifiedOn: '5/23/2025 12:22 PM' },
        { subject: 'Monthly account statement', from: '---', to: '---', regarding: 'Sampat Kuntal222', priority: 'High', status: 'Draft', modifiedOn: '5/23/2025 12:20 PM' },
        ...
        { subject: 'Welcome!', from: 'CRM Trial', to: 'Virat Singh Sirix Demo', regarding: 'Virat Singh Sirix Demo', priority: 'Normal', status: 'Pending Send', modifiedOn: '2/24/2025 12:44 PM' },
        ...
        { subject: 'Welcome!', from: 'CRM Trial', to: 'Rohit Sharma', regarding: 'Rohit Sharma', priority: 'Normal', status: 'Pending Send', modifiedOn: '2/23/2025 3:12 PM' },
        { subject: 'Welcome!', from: 'CRM Trial', to: 'akhsdasd jkhasdfasd', regarding: 'akhsdasd jkhasdfasd', priority: 'Normal', status: 'Pending Send', modifiedOn: '2/21/2025 2:17 PM' },
        { subject: 'Welcome!', from: 'CRM Trial', to: 'acsaca ascasc', regarding: 'acsaca ascasc', priority: 'Normal', status: 'Pending Send', modifiedOn: '2/20/2025 11:53 PM' },
        { subject: 'Welcome!', from: 'CRM Trial', to: 'asdsad asdas', regarding: 'asdsad asdas', priority: 'Normal', status: 'Pending Send', modifiedOn: '2/20/2025 11:53 PM' },
        { subject: 'Welcome!', from: 'CRM Trial', to: 'john key', regarding: 'john key', priority: 'Normal', status: 'Pending Send', modifiedOn: '2/20/2025 6:43 PM' },
        { subject: 'Welcome!', from: 'CRM Trial', to: 'jj jj', regarding: 'jj jj', priority: 'Normal', status: 'Pending Send', modifiedOn: '2/19/2025 3:23 PM' },
        { subject: 'Welcome!', from: 'CRM Trial', to: 'ddd ddd', regarding: 'ddd ddd', priority: 'Normal', status: 'Pending Send', modifiedOn: '2/19/2025 2:21 PM' },
        { subject: 'Welcome!', from: 'CRM Trial', to: 'Tal Laitner', regarding: 'Tal Laitner', priority: 'Normal', status: 'Pending Send', modifiedOn: '2/17/2025 11:49 AM' },
        { subject: 'Welcome!', from: 'CRM Trial', to: 'Arsyad Eko', regarding: 'Arsyad Eko', priority: 'Normal', status: 'Pending Send', modifiedOn: '2/16/2025 4:06 AM' },
        { subject: 'Welcome!', from: 'CRM Trial', to: '20MUG090 Surya T', regarding: '20MUG090 Surya T', priority: 'Normal', status: 'Pending Send', modifiedOn: '2/15/2025 8:09 PM' },
    ];
                ...
                <main className={styles.contentArea}>
                                    ...
                                    <tr key={idx} className={styles.gridRow}>
                                        ...
                                        {columnDefs.map((col, colIdx) => (
                                            <td key={colIdx} className={styles.gridCell} style={{ 
                                                ...
                                                backgroundColor: item.status === 'Draft' ? '#e6e6e6' : 'transparent'
                                            }}>
                                                {item[col.key]}
                                            </td>
                                        ))}
                    ...
                    <div className={styles.footer}>
                        ...
                        <div className={styles.pagination}>
                            <span>1 - {Math.min(100, emails.length)} of {emails.length}</span>
                            <span>⏮️</span>
                            <span>Page 1 ⌄</span>
                            <span>⏭️</span>
                        </div>
