                ...
                <main className={styles.contentArea}>
                    <div className={styles.commandBar}>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            {showNewDropdown && <div style={{ position: 'absolute', top: '100%', left: 0, background: 'white', border: '1px solid #e1dfdd', boxShadow: '0 2px 8px rgba(0,0,0,0.15)', minWidth: '180px', zIndex: 1000 }}><div style={{ padding: '8px 16px', cursor: 'pointer', fontSize: '14px' }} onClick={() => { router.push('/live-demo/admin/reports/new'); setShowNewDropdown(false); }}>Blank Report</div><div style={{ padding: '8px 16px', cursor: 'pointer', fontSize: '14px' }} onClick={() => { alert('Create from template'); setShowNewDropdown(false); }}>From Template</div></div>}
                        </div>
