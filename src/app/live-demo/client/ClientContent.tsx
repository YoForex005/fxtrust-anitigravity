...
export default function ClientContent() {
    ...
    return (
        <div className={styles.yopipsApp}>
            {/* Sidebar */}
            <aside className={styles.yopipsSidebar}>
                {/* Logo area */}
                <div className={styles.yopipsLogo}>
                    <Image src="/fxtrustwhite.png" alt="Yo Pips" width={130} height={34} style={{ objectFit: 'contain' }} />
                </div>
                ...
                <div className={styles.menuSection} style={{ marginTop: 'auto' }}>
                    ...
                    <div className={styles.menuItem}>
                        <div className={styles.menuItemLeft}>
                            <div style={{ width: 18, height: 18, borderRadius: '50%', backgroundColor: '#4353F2', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                <span style={{ fontSize: 10, color: '#000', fontWeight: 'bold' }}>Q</span>
                            </div>
                            Siddhartha
                        </div>
                        <span style={{ fontSize: 10, color: '#4353F2' }}>PRO</span>
                    </div>
                                                ...
                                                <tr key={i}>
                                                    <td>
                                                        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                                                            <span style={{ color: '#4353F2', backgroundColor: 'rgba(67, 83, 242,0.1)', padding: '4px 8px', borderRadius: 4, fontSize: 12, fontWeight: 600 }}>FX TRUSTS</span>
                                ...
                                <div className={styles.challengeStepsCol}>
                                    ...
                                    <div className={styles.cStepBlock}>
                                        ...
                                        <div className={styles.cSizeGrid}>
                                            ...
                                            <div className={`${styles.cSizeCard} ${styles.selected}`}>
                                                <div className={styles.cSizeValue} style={{ color: '#4353F2' }}>$50,000</div>
                                    ...
                                    <div className={styles.cStepBlock}>
                                        ...
                                        <div className={styles.cCardFull}>
                                            ...
                                            <div className={styles.cRadioIcon} style={{ borderColor: '#4353F2', backgroundColor: '#4353F2', color: '#000' }}>
                                                <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="4"><polyline points="20 6 9 17 4 12"></polyline></svg>
                                            </div>
                                        </div>
                                    </div>
