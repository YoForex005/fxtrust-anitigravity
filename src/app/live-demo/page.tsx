...
import { ViewType, ClientViewType } from './types';
...
export default function LiveDemoPage() {
    ...
    const [userMode, setUserMode] = useState<'admin' | 'client'>('admin');
    const [activeTab, setActiveTab] = useState('dashboard');
    const [showNotifications, setShowNotifications] = useState(false);
    const [currentView, setCurrentView] = useState<ViewType>('dashboard');
    const [clientView, setClientView] = useState<ClientViewType>('client-dashboard');
    ...
    const handleSwitchMode = () => {
        if (userMode === 'admin') {
            ...
            setClientView('client-dashboard');
        } else {
            setUserMode('admin');
            setActiveTab('dashboard');
            ...
            <div className={styles.dashboardLayout}>
                ...
                <main className={styles.mainContent}>
                    ...
                    {userMode === 'admin' ? (
                        ...
                        <ClientViewManager currentView={clientView} onViewChange={setClientView} />
                    )}
                </main>
            </div>
        </div>
