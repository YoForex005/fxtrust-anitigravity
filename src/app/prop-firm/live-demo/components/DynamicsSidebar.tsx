...
export default function DynamicsSidebar({ activeItem = 'Accounts', onNavigate }: DynamicsSidebarProps) {
    ...
    const [recentItems, setRecentItems] = useState<{ label: string, path: string }[]>([
        { label: 'Active Accounts', path: '/prop-firm/live-demo/admin' },
        { label: 'Real-Time Trading', path: '/prop-firm/live-demo/admin/trading' },
        { label: 'All Transactions', path: '/prop-firm/live-demo/admin/transactions' }
    ]);
    ...
    return (
        <aside className={styles.sidebar}>
            <div className={styles.sidebarGroup}>
                <div className={styles.sidebarItem} onClick={() => handleNavigate('Home', '/prop-firm/live-demo/admin')}>
                ...
                <div className={styles.sidebarItem} onClick={() => toggleGroup('pinned')}>
                 ...
                 {expandedGroups['pinned'] && (
                    <div className={styles.sidebarSubGroup}>
                        <div className={styles.sidebarItem} onClick={() => handleNavigate('Accounts', '/prop-firm/live-demo/admin')}>Active Accounts</div>
                        <div className={styles.sidebarItem} onClick={() => handleNavigate('Real-Time Trading', '/prop-firm/live-demo/admin/trading')}>Real-Time Trading</div>
                        <div className={styles.sidebarItem} onClick={() => handleNavigate('Monetary Transactions', '/prop-firm/live-demo/admin/transactions')}>Monetary Transactions</div>
                        <div className={styles.sidebarItem} onClick={() => handleNavigate('Phone Calls', '/prop-firm/live-demo/admin/phone-calls')}>Phone Calls</div>
                        <div className={styles.sidebarItem} onClick={() => handleNavigate('Active Cases', '/prop-firm/live-demo/admin/cases')}>Active Cases</div>
                    </div>
                )}
            </div>
            ...
            <div className={styles.sidebarGroup}>
                ...
                <div 
                    ...
                    onClick={() => handleNavigate('Accounts', '/prop-firm/live-demo/admin')}
                >
                ...
                <div 
                    ...
                    onClick={() => handleNavigate('Monetary Transactions', '/prop-firm/live-demo/admin/transactions')}
                >
                ...
                <div 
                    ...
                    onClick={() => handleNavigate('Real-Time Trading', '/prop-firm/live-demo/admin/trading')}
                >
            ...
            <div className={styles.sidebarGroup}>
                ...
                <div 
                    ...
                    onClick={() => handleNavigate('Phone Calls', '/prop-firm/live-demo/admin/phone-calls')}
                >
                ...
                <div 
                    ...
                    onClick={() => handleNavigate('All E-mails', '/prop-firm/live-demo/admin/emails')}
                >
            ...
            <div className={styles.sidebarGroup}>
                ...
                <div 
                    ...
                    onClick={() => handleNavigate('Documents', '/prop-firm/live-demo/admin/documents')}
                >
                ...
                <div 
                    ...
                    onClick={() => handleNavigate('Active Cases', '/prop-firm/live-demo/admin/cases')}
                >
            ...
            <div className={styles.sidebarGroup}>
                ...
                <div 
                    ...
                    onClick={() => handleNavigate('Dashboards', '/prop-firm/live-demo/admin/dashboards')}
                >
                ...
                <div 
                    ...
                    onClick={() => handleNavigate('Reports', '/prop-firm/live-demo/admin/reports')}
                >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /><polyline points="10 9 9 9 8 9" /></svg>
                    Reports
                </div>
