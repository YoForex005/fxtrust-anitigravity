...
export default function ReportsContent() {
    ...
    const reports = [
        { name: 'Accounts Activity by Tag', createdBy: 'CRM Admin', createdOn: '3/1/2020 12:47 PM', modifiedOn: '5/18/2025 4:25 PM', description: 'Sub Tag Report' },
        { name: 'Business Performance Report', createdBy: 'Leverate Administrator', createdOn: '3/26/2023 4:21 PM', modifiedOn: '5/18/2025 4:25 PM', description: 'View accumulative data' },
        { name: 'Dynamic Conversion Report', createdBy: 'Leverate Administrator', createdOn: '3/26/2023 4:21 PM', modifiedOn: '10/5/2025 10:55 AM', description: 'Measure agents conversion' },
        { name: 'Dynamic Retention Report', createdBy: 'Leverate Administrator', createdOn: '3/26/2023 4:21 PM', modifiedOn: '5/18/2025 4:26 PM', description: 'Measure retention performance' },
        { name: 'Users and Roles', createdBy: 'SYSTEM', createdOn: '8/28/2019 3:17 PM', modifiedOn: '5/18/2025 4:26 PM', description: 'View user contact and security' },
    ];
                ...
                <main className={styles.contentArea}>
                    <div className={styles.commandBar}>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            {showNewDropdown && <div style={{ position: 'absolute', top: '100%', left: 0, background: 'white', border: '1px solid #e1dfdd', boxShadow: '0 2px 8px rgba(0,0,0,0.15)', minWidth: '180px', zIndex: 1000 }}><div style={{ padding: '8px 16px', cursor: 'pointer', fontSize: '14px' }} onClick={() => { router.push('/prop-firm/live-demo/admin/reports/new'); setShowNewDropdown(false); }}>Blank Report</div><div style={{ padding: '8px 16px', cursor: 'pointer', fontSize: '14px' }} onClick={() => { alert('Create from template'); setShowNewDropdown(false); }}>From Template</div></div>}
                        </div>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            {showExcelDropdown && <div style={{ position: 'absolute', top: '100%', left: 0, background: 'white', border: '1px solid #e1dfdd', boxShadow: '0 2px 8px rgba(0,0,0,0.15)', minWidth: '180px', zIndex: 1000 }}><div style={{ padding: '8px 16px', cursor: 'pointer', fontSize: '14px' }} onClick={() => { alert('Downloading template...'); setShowExcelDropdown(false); }}>Report Template</div></div>}
                        </div>
                        <div style={{ position: 'relative' }}>
                            <button className={styles.commandButton} onClick={() => setShowExportDropdown(!showExportDropdown)}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" style={{ color: '#107c10' }}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /></svg>Export to Excel ⌄</button>
                            {showExportDropdown && <div style={{ position: 'absolute', top: '100%', left: 0, background: 'white', border: '1px solid #e1dfdd', boxShadow: '0 2px 8px rgba(0,0,0,0.15)', minWidth: '180px', zIndex: 1000 }}><div style={{ padding: '8px 16px', cursor: 'pointer', fontSize: '14px' }} onClick={() => { alert('Exporting all...'); setShowExportDropdown(false); }}>Export All</div><div style={{ padding: '8px 16px', cursor: 'pointer', fontSize: '14px' }} onClick={() => { alert('Exporting selected...'); setShowExportDropdown(false); }}>Export Selected</div></div>}
                        </div>
                        <div style={{ position: 'relative' }}>
                    ...
                    <div className={styles.viewHeader}><div className={styles.viewTitle}>Admin Reports view ⌄</div><div style={{ flex: 1 }} /><div className={styles.commandButton} style={{ border: '1px solid #e1dfdd', padding: '4px 8px', borderRadius: '2px', background: 'white' }}>Search this view</div></div>
