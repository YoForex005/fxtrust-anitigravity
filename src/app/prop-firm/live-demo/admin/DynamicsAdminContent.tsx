            ...
            <div className={styles.mainLayout}>
                ...
                <main className={styles.contentArea}>
                    ...
                    <div className={styles.commandBar}>
                        ...
                        <button className={styles.commandButton} onClick={() => router.push('/prop-firm/live-demo/admin/new')}>
                            ...
                            <div style={{ width: '280px', borderRight: '1px solid #e1dfdd', background: '#f3f2f1', display: 'flex', flexDirection: 'column' }}>
                                ...
                                <div style={{ flex: 1, padding: '8px', overflowY: 'auto' }}>
                                    {['Sales Overview', 'Account Performance', 'Revenue Trends', 'Customer Activity', 'Lead Pipeline'].map((dash, i) => (
                                        <div key={i} style={{ padding: '10px 12px', background: 'white', marginBottom: '4px', cursor: 'pointer', borderRadius: '2px', fontSize: '13px' }} onClick={() => router.push('/prop-firm/live-demo/admin/dashboards')}>
                                            {dash}
                                        </div>
                                    ))}
                                </div>
                                        ...
                                        >
                                            ...
                                            {columnDefs.map((col, colIdx) => (
                                                <td
                                                    ...
                                                    onClick={() => router.push(`/prop-firm/live-demo/admin/${idx}`)}
                                                >
