...
export default function CasesPage() {
    return (
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"WebPage","name":"Support Case Management | Ticketing System | FxTrusts","description":"Track and resolve client issues efficiently with the integrated support ticketing system.","url":"https://fxtrusts.com/prop-firm/live-demo/admin/cases"}) }}
      />
