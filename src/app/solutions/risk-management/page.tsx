                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.faqGrid}>
                        <div className={styles.faqCard}>
                            <h3>Can I set different leverage for different groups?</h3>
                            <p>
                                Yes. Give "Pro" traders 1:500 and "Retail" traders 1:30. Dynamically lower leverage
                                on weekends, during news events, or for specific high-risk symbols.
                            </p>
                        </div>
                        <div className={styles.faqCard}>
                            <h3>Does it work with A-Book execution?</h3>
                            <p>
                                Absolutely. Even with 100% A-Book, you have "credit risk" with your LP. Our system
                                monitors your margin level at the LP to ensure you don't get stopped out unexpectedly.
                            </p>
                        </div>
                        <div className={styles.faqCard}>
                            <h3>Can I identify "toxic" traders?</h3>
                            <p>
                                Yes. We score every client based on profitability, trading style, and win rate.
                                Automatically A-book the winners, B-book the losers.
                            </p>
                        </div>
                        <div className={styles.faqCard}>
                            <h3>What if I want to manually intervene?</h3>
                            <p>
                                The Dealer Dashboard lets you manually close positions, adjust quotes, or pause
                                trading for specific clients. Full control when you need it.
                            </p>
                        </div>
                        <div className={styles.faqCard}>
                            <h3>Can I set symbol-specific limits?</h3>
                            <p>
                                Yes. Set different exposure limits per symbol. Example: 200 lots max on EURUSD,
                                50 lots max on XAUUSD, 10 lots max on BTCUSD.
                            </p>
                        </div>
                        <div className={styles.faqCard}>
                            <h3>How fast are alerts delivered?</h3>
                            <p>
                                Telegram and Slack alerts arrive in under 2 seconds. Email within 10 seconds.
                                Fast enough to act before the market moves further.
                            </p>
                        </div>
                    </div>
                </div>
