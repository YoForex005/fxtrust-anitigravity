                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.faqGrid}>
                        <div className={styles.faqCard}>
                            <h3>What are the processing fees?</h3>
                            <p>
                                We charge a flat 1% processing fee. Network fees (gas) are paid by the sender.
                                No monthly fees, no setup costs, no hidden charges.
                            </p>
                        </div>
                        <div className={styles.faqCard}>
                            <h3>Is it truly irreversible?</h3>
                            <p>
                                Yes. Blockchain transactions are final once confirmed. This is a feature, not a
                                bug—it means you never have to worry about chargeback fraud again.
                            </p>
                        </div>
                        <div className={styles.faqCard}>
                            <h3>What about AML/KYC compliance?</h3>
                            <p>
                                We integrate with Chainalysis for transaction screening. Flagged deposits are
                                held for review. You maintain full compliance with your jurisdiction's requirements.
                            </p>
                        </div>
                        <div className={styles.faqCard}>
                            <h3>How fast are withdrawals?</h3>
                            <p>
                                Automated withdrawals process within 5 minutes of approval. Large withdrawals
                                may require additional verification depending on your configured limits.
                            </p>
                        </div>
                        <div className={styles.faqCard}>
                            <h3>Do I need my own crypto wallet?</h3>
                            <p>
                                No. We handle the wallets and custody. You just provide a destination address
                                (your cold wallet or exchange) where you want funds swept.
                            </p>
                        </div>
                        <div className={styles.faqCard}>
                            <h3>What if crypto price drops during conversion?</h3>
                            <p>
                                We use real-time spot rates with no slippage window. The rate is locked the
                                moment the deposit is confirmed—no surprises.
                            </p>
                        </div>
                    </div>
                </div>
