...
const PlanEdit = () => {
    ...
    const [planData, setPlanData] = useState(initialPlanData[id] || initialPlanData[140]);
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-[150px_1fr] items-center gap-4">
                            ...
                            <input
                                ...
                                className="bg-background border border-border rounded px-3 py-2 text-text-main text-sm focus:outline-none focus:border-primary"
                            />
                        </div>
                        ...
                        <div className="grid grid-cols-[150px_1fr] items-start gap-4">
                            ...
                            <textarea
                                ...
                                rows="3"
                                className="bg-background border border-border rounded px-3 py-2 text-text-main text-sm focus:outline-none focus:border-primary resize-none"
                            />
                        </div>
                        ...
                        <div className="grid grid-cols-[150px_1fr] items-center gap-4">
                            ...
                            <input
                                type="text"
                                value={planData.pngTemplateFile}
                                onChange={(e) => handleInputChange('pngTemplateFile', e.target.value)}
                                className="bg-background border border-border rounded px-3 py-2 text-text-muted text-sm focus:outline-none focus:border-primary"
                            />
                        </div>
                    </div>
                </div>
