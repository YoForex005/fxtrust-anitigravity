...
const CreateFakeGateway = () => {
    ...
    const handleSubmit = (e) => {
        ...
        alert('Fake Gateway created successfully!');
        navigate('/payment-gateways/fake');
    };
        ...
        <div className="space-y-6 animate-in fade-in zoom-in duration-300">
            ...
            <div className="glass-panel rounded-2xl border border-border overflow-hidden bg-surface">
                ...
                <div className="p-4 border-b border-border flex justify-between items-center bg-surface/50">
                    ...
                    <button
                        onClick={() => navigate('/payment-gateways/fake')}
                        ...
                        <div className="flex-1">
                            <div className="w-48 h-56 bg-surface border border-border rounded-lg relative flex flex-col items-center justify-center p-4">
                                <div className="flex-1 flex items-center justify-center">
                                    <div className="w-16 h-16 bg-white/5 rounded border border-border flex items-center justify-center opacity-40">
                                        <ImageOff className="w-8 h-8 text-text-muted" />
                                    </div>
                                </div>
                                <div className="text-[10px] text-text-muted mb-4 font-mono">fake.png</div>
...
export default CreateFakeGateway;
