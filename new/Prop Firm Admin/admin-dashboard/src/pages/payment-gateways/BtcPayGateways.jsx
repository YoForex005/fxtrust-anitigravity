    ...
    const initialWays = [
        {
            ...
            enabled: true,
            created: '2 years ago',
            createdAt: '2023-08-26 09:11:18',
            serverUrl: 'https://btcpay.dev4traders.com',
            apiKey: 'Key',
            storeId: 'ID'
        }
    ];
        ...
        <div className="space-y-6 animate-in fade-in zoom-in duration-300">
            ...
            <div>
                <div className="flex items-center gap-2 mb-1">
                    <h1 className="text-2xl font-bold text-text-main">BtcPay Payment Gateways</h1>
                    <span className="text-text-muted text-sm border-l border-border pl-2">BtcPay Payment Gateways</span>
            ...
            <div className="glass-panel p-6 rounded-2xl border border-border">
                ...
                <div className="mt-6 flex items-center gap-8">
                    <div className="flex items-center gap-3">
                        <span className="text-sm font-medium text-text-main">Enable BtcPay</span>
            ...
            <div className="flex justify-between items-center">
                ...
                <button
                    onClick={() => navigate('/payment-gateways/btcpay/new')}
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-surface/50 text-text-muted text-xs font-medium border-b border-border">
                                ...
                                <th className="p-4 font-medium whitespace-nowrap">Server Url</th>
                                <th className="p-4 font-medium whitespace-nowrap">Api Key</th>
                                <th className="p-4 font-medium whitespace-nowrap">Store Id</th>
                        ...
                        <tbody className="divide-y divide-border text-sm">
                            {ways.map((item) => (
                                <tr key={item.id} className="group hover:bg-surface/40 transition-colors">
                                    ...
                                    <td className="p-4">
                                        <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center border border-border">
                                    ...
                                    <td className="p-4 text-text-muted truncate max-w-[200px]">{item.serverUrl}</td>
                                    <td className="p-4 text-text-muted">{item.apiKey}</td>
                                    <td className="p-4 text-text-muted">{item.storeId}</td>
                                    <td className="p-4 text-center">
