        ...
        <div className="space-y-6 animate-in fade-in zoom-in duration-300">
            ...
            <div>
                <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-text-muted text-sm border-l border-border pl-2">CoinGate Payment Gateways</span>
            ...
            <div className="flex justify-between items-center">
                ...
                <button
                    onClick={() => navigate('/payment-gateways/coingate/new')}
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-surface/50 text-text-muted text-xs font-medium border-b border-border">
                                ...
                                <th className="p-4 font-medium whitespace-nowrap">Api Token</th>
                                <th className="p-4 font-medium whitespace-nowrap">Is Sandbox</th>
                        ...
                        <tbody className="divide-y divide-border text-sm">
                            {gateWays.length === 0 ? (
                                <tr>
                                    <td colSpan="9" className="p-8 text-center text-text-muted bg-white/5">
                                ...
                                gateWays.map((item) => (
                                    ...
                                    <tr key={item.id}><td colSpan="9"></td></tr>
                                ))
                            )}
                        </tbody>
                    </table>
...
export default CoinGateGateways;
